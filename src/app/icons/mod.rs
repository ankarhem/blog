...
#[component]
pub fn GithubIcon(cx: Scope, class: String) -> impl IntoView {
    view! {
        cx,
...
#[component]
pub fn TwitterIcon(cx: Scope, class: String) -> impl IntoView {
    view! {
        cx,
...
#[component]
pub fn EmailIcon(cx: Scope, #[prop(default = "".into())] class: String) -> impl IntoView {
    view! {
        cx,
